...
pub fn instant_pit_attack_11(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_pit_attack_12(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(4.0, true)
    }
...
pub fn instant_pit_attack_13(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_excute){
...
pub fn instant_pit_attack_dash(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_pit_attack_s3(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_pit_attack_hi3(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_pit_attack_lw3(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(5.0, true)
    }
...
pub fn instant_pit_attack_s4_s(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_pit_attack_hi4(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(5.0, true)
    }
...
pub fn instant_pit_attack_lw4(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_pit_attack_air_n(fighter: &mut L2CFighterCommon) {
    acmd!({
    frame(Frame=4)
    if(is_excute){
...
pub fn instant_pit_attack_air_f(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_excute){
...
pub fn instant_pit_attack_air_b(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_excute){
        MotionModule::set_frame(9.0, true)
        WorkModule::on_flag(Flag=FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING)
...
pub fn instant_pit_attack_air_hi(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_pit_attack_air_lw(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(9.0, true)
    }
...
pub fn instant_pit_special_s_start(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_pit_special_air_s_start(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_excute){
...
pub fn install() {
    if CONFIG.instant_info.pit{
        acmd::add_hooks!(
        instant_pit_attack_11,
        instant_pit_attack_12,
        instant_pit_attack_13,
        instant_pit_attack_dash,
        instant_pit_attack_s3,
        instant_pit_attack_hi3,
        instant_pit_attack_lw3,
        instant_pit_attack_s4_s,
        instant_pit_attack_hi4,
        instant_pit_attack_lw4,
        instant_pit_attack_air_n,
        instant_pit_attack_air_f,
        instant_pit_attack_air_b,
        instant_pit_attack_air_hi,
        instant_pit_attack_air_lw,
        instant_pit_special_s_start,
        instant_pit_special_air_s_start,
        //instant_pit_special_lw,
        //instant_pit_special_air_lw
    );
    }
}