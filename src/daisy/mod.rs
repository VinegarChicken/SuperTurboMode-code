...
pub fn instant_daisy_attack_s4(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
...
pub fn instant_daisy_attack_hi4(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
...
pub fn instant_daisy_attack_11(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
            MotionModule::set_frame(module_accessor, 1.0, true)
            }
        }
    }
    frame(Frame=2)
...
pub fn instant_daisy_attack_dash(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
...
pub fn instant_daisy_attack_s3s(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
...
pub fn instant_daisy_attack_hi3(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
...
pub fn instant_daisy_attack_lw3(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
...
pub fn instant_daisy_attack_lw4(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
...
pub fn instant_daisy_attack_air_n(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
...
pub fn instant_daisy_attack_air_f(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
...
pub fn instant_daisy_attack_air_b(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
...
pub fn instant_daisy_attack_air_hi(fighter: &mut L2CFighterCommon) {
    acmd!({
    if (is_excute) {
        rust{
            if CONFIG.instant_info.daisy{
...
pub fn install() {
    acmd::add_hooks!(
        instant_daisy_attack_11,
        instant_daisy_attack_dash,
        instant_daisy_attack_s3s,
        instant_daisy_attack_hi3,
        instant_daisy_attack_lw3,
        instant_daisy_attack_s4,
        instant_daisy_attack_hi4,
        instant_daisy_attack_lw4,
        instant_daisy_attack_air_n,
        instant_daisy_attack_air_f,
        instant_daisy_attack_air_b,
        instant_daisy_attack_air_hi,
    );
}
