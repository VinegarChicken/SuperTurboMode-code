...
pub fn instant_samusd_attack_11(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_samusd_attack_12(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_samusd_attack_dash(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_samusd_attack_s3hi(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(7.0, true)
    }
...
pub fn instant_samusd_attack_s3(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(7.0, true)
    }
...
pub fn instant_samusd_attack_s3lw(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(7.0, true)
    }
...
pub fn instant_samusd_attack_hi3(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_samusd_attack_lw3(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(5.0, true)
    }
...
pub fn instant_samusd_attack_s4_hi(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_samusd_attack_s4_s(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(9.0, true)
    }
...
pub fn instant_samusd_attack_s4_lw(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(9.0, true)
    }
...
pub fn instant_samusd_attack_hi4(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_samusd_attack_lw4(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_samusd_attack_air_n(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(7.0, true)
    }
...
pub fn instant_samusd_attack_air_f(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(5.0, true)
        WorkModule::on_flag(Flag=FIGHTER_STATUS_ATTACK_AIR_FLAG_ENABLE_LANDING)
...
pub fn instant_samusd_attack_air_b(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(8.0, true)
    }
...
pub fn instant_samusd_attack_air_hi(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_samusd_attack_air_lw(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_samusd_special_s(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
...
pub fn instant_samusd_special_air_s(fighter: &mut L2CFighterCommon) {
    acmd!({
    if(is_execute){
        MotionModule::set_frame(20.0, true)
    }
...
pub fn install() {
    //if CONFIG.instant_info.banjo{
        acmd::add_hooks!(
        instant_samusd_attack_11,
        instant_samusd_attack_12,
        instant_samusd_attack_dash,
        instant_samusd_attack_s3,
        instant_samusd_attack_hi3,
        instant_samusd_attack_lw3,
        instant_samusd_attack_s4_s,
        instant_samusd_attack_hi4,
        instant_samusd_attack_lw4,
        instant_samusd_attack_air_n,
        instant_samusd_attack_air_f,
        instant_samusd_attack_air_b,
        instant_samusd_attack_air_hi,
        instant_samusd_attack_air_lw,
        instant_samusd_special_s,
        instant_samusd_special_air_s,
    );
    //}
